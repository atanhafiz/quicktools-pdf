...
// Strict Word → PDF conversion simulation
const processFiles = async (files, setProgress, outputName, setError, setFile) => {
  try {
    ...
    // Default output name
    let defaultName = file.name.replace(/\.(doc|docx)$/i, ".pdf");
    ...
    <div className="flex justify-center items-start mt-16 px-4">
      <div className="w-full max-w-xl p-6 bg-white dark:bg-gray-900 rounded-xl shadow-lg">
        ...
        <p className="text-gray-700 dark:text-gray-200 mb-6">
          Convert Word documents into high-quality PDF files. Only .doc and .docx files are accepted.
        </p>
        ...
        <div className="mb-4">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
            Default will follow original Word file name.
          </p>
        </div>
        ...
        <PdfToolWrapper
          key={resetKey}
          title="Word to PDF"
          description="Transform Word documents into PDFs"
