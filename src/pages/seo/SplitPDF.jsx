...
export default function SplitPDF() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <Helmet>
        <title>Split PDF – Extract pages easily | QuickTools</title>
        <meta name="description" content="Split PDF online free. Extract pages easily from large documents. Fast, secure, no watermark." />
        <meta name="keywords" content="split pdf, extract pages from pdf, pdf splitter online, split pdf pages" />
      </Helmet>

      <section className="mx-auto max-w-5xl px-6 py-12">
        <header className="text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Split PDF – Extract pages easily</h1>
        ...
        <div className="mt-8 rounded-2xl border-2 border-dashed border-fuchsia-400 bg-white p-8 shadow-sm">
          ...
          <div className="flex flex-col items-center gap-3 md:flex-row md:justify-center">
            <button onClick={() => navigate("/tools/split")} className="w-full md:w-auto rounded-lg bg-fuchsia-600 px-6 py-3 font-medium text-white shadow hover:bg-fuchsia-700 transition">Upload Files</button>
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          <div>
            <h2 className="text-xl font-semibold">How to Split PDF Free</h2>
            <ol className="mt-3 list-decimal space-y-2 pl-6 text-gray-700">
              <li>Open QuickTools → Split PDF</li>
              <li>Upload your PDF file</li>
              <li>Select pages to extract</li>
              <li>Click <b>Split Now</b> → Download result</li>
            </ol>
          </div>
          <div>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-6 text-gray-700">
              ...
              <li>Remove cover pages or ads</li>
              <li>Separate invoices by client</li>
